"""
Django settings for kriangle project.
...
SECRET_KEY = 'django-insecure-y*sd(^dgn@1v99yq9(-(pkdx)k-p16^w7cv70pm#&jyx1l8&1z'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = ['54.196.147.165','www.kriangle.com','kriangle.com']
...
WSGI_APPLICATION = 'kriangle.wsgi.application'
...
STATIC_URL = '/static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')  # Define a folder to collect static files
...
EMAIL_HOST_PASSWORD = 'swjf ceoe adxv engz'       # Your Gmail App Password (do not use your regular Gmail password)
